...
class MyLinkedList3 {
    ...
    public void insertAfter(Node prev_node, int newData){
        ...
        Node newNode = new Node(newData);
        newNode.next = prev_node.next;//update:value
        prev_node.next = newNode;//update:address
    }
...
public class P_03_InsertionAfterAnyNode{   
    public static void main(String[] args) {
        MyLinkedList3 llist = new MyLinkedList3();
        llist.insertAtEnd(2);
        llist.insertAtEnd(4);
        llist.insertAtEnd(8);
       ...
       try {
		...
		llist.insertAfter(llist.head.next.next.next.next, 12);
	} catch (Exception e) {
